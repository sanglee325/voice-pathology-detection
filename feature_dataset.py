...
class MFCC13Dataset(Dataset):
    def __init__(self, data_dir, desc="train", time_size=475):
        self.data_dir = os.path.join(data_dir, "MFCC13", desc)
        self.label_dir = os.path.join(data_dir, "MFCC13", "label")
...
class MFCC40Dataset(Dataset):
    def __init__(self, data_dir, desc="train", time_size=475):
        self.data_dir = os.path.join(data_dir, "MFCC40", desc)
        self.label_dir = os.path.join(data_dir, "MFCC40", "label")
        self.time_size = time_size
        self.file_path_name = os.listdir(self.data_dir)
        self.data, self.labels = [], []
